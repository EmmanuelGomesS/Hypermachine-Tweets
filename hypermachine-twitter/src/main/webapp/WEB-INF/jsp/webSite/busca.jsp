...
<li class="box col-xs-6 col-md-4 col-sm-6 col-lg-3 ">
        ...
        <div class="embed-container hidden" ><iframe width="225" height="195" src="${litmusicas.location}"></iframe></div>
        ...
        <button class="btn-unstyled btn-play-video">
    		...
    		<a href="https://twitter.com/share" class="twitter-share-button" data-via="hypermachine_tweets - Gostei da musica" data-url="${litmusicas.location}"  data-lang="pt" data-count="none">Tweetar</a>
			...
			<div id="txt_3" class="dialog but22" title="Album da música!"><img src="${litmusicas.album}"></div>

			<a id="ssba_facebook_share" href="https://www.facebook.com/dialog/feed?app_id=19507961798&amp;display=popup&amp;redirect_uri=https%3A//${litmusicas.tipo}.com/fb_popup_callback.html&amp;link=${litmusicas.location}%3Futm_source%3D${litmusicas.tipo}%26utm_campaign%3Dshare%26utm_medium%3Dfacebook" target="_blank"><button class="facebook">Share</button></a>
