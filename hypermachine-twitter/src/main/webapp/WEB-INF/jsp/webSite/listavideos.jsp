...
<div id="container-folio" style="position:relative">
	<c:forEach items="${listvideos}" var="listvideos">
		<li class="box col-xs-6 col-md-4 col-sm-6 col-lg-3 graphics design">
		    ...
		    <div >
		        ...
		        <div class="embed-container hidden" ><iframe width="225" height="195" src="http://www.youtube.com/embed/${listvideos.midia.location}" frameborder="0" allowfullscreen></iframe></div>
		        <div class="preview"><img alt="YouTube" width="225" height="195"  src="http://i.ytimg.com/vi/${listvideos.midia.imgMidia}/mqdefault.jpg"  />
		        ...
		        <img  class="playImg" alt="Start video" height="92" src="http://assets1.fcbarcelona.com/images/btn-play-video@2x.2423a3d78.png" width="100" />
		    		...
		    		<a href="https://twitter.com/share" class="twitter-share-button" data-via="hypermachine_tweets" data-url="http://www.youtube.com/embed/${listvideos.midia.location}"  data-lang="pt" data-count="none">Tweetar</a>
					<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script>
					
					<div class="img " title="Contas que twittaram essa música!"><h4>'${listvideos.listUser}' </h4></div>
			
			<button id="lk_3" class="dialog_link ui-state-default ui-corner-all but2 btn-primary" type="button" href="#">Detalhes</button>
			<div id="txt_3" class="dialog but22" title="Album da música!"><img src="${listvideos.midia.album}"></div>
